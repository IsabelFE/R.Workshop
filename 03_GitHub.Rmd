...
You can also use command line in the Terminal or the *Terminal* tab on R Studio. You need to install the[GitHub CLI manual](https://cli.github.com/manual/). aproved
...
If you have admin privileges you can create and merge your own pull request in a few steps:
